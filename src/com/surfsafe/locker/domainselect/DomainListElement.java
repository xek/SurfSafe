 ...
 * 
 */
public class DomainListElement implements Comparable<DomainListElement> {
	...
	public DomainListElement(String label, PackageItemInfo pii, int priority) {
		this.title = label;
		this.pii = pii;
	...
	/** For separators */
	public DomainListElement(String label, int priority) {
		this.title = label;
		this.pii = null;
		this.packageName = "";
		this.priority = priority;
	...
	public DomainListElement(String label, String packageName, int priority) {
		this.title = label;
		this.pii = null;
	...
	public final boolean equals(Object object) {
		if (object == null)
			return false;
		if (!(object instanceof DomainListElement))
			return false;
		DomainListElement sh = (DomainListElement) object;
		if (isApp() != sh.isApp())
			return false;
		if (!isApp()) {
	...
	@Override
	public int compareTo(DomainListElement o) {
